...
export const settingDefinitions = {
  ...
  PAYMENT_TIMEOUT_MINUTES: { sensitive: false, fallback: "60" },
  ALDIQRIS_API_KEY: { sensitive: true },
  ALDIQRIS_BASE_URL: { sensitive: false, fallback: "https://aldiqris.pages.dev/api" },
  CLIPKU_PAY_API_KEY: { sensitive: true },
  CLIPKU_PAY_BASE_URL: { sensitive: false, fallback: "https://pay.clipku.com/api" },
  CLIPKU_PAY_WEBHOOK_SECRET: { sensitive: true },
  ...
  GOOGLE_CLIENT_ID: { sensitive: false },
  GOOGLE_CLIENT_SECRET: { sensitive: true },
  GOOGLE_REDIRECT_URI: { sensitive: false },
