...
export function AdminMonitoring() {
  ...
  return <div className="monitoring-page">
    ...
    <div className="admin-stats monitoring-stats">
      ...
      <div className="panel"><Database/>Playback gagal<strong>{s.failedPlayback}</strong></div><div className="panel"><MemoryStick/>Memory server<strong>{data.system.memoryMb} MB</strong></div>
    </div>
