...
const links=["dashboard","users","subscriptions","payments","invoices","devices","reports","contents","providers","categories","plans","coupons","api-clipku","api-clipku/documentation","api-clipku/providers","api-clipku/endpoints","api-clipku/tester","api-clipku/mapper","api-clipku/sync","api-clipku/logs","api-clipku/cache","settings","seo","payment-settings","logs","error-logs"];
